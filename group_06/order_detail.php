...
<div class="page-head_agile_info_w3l">
  ...
  <!-- banner-bootom-w3-agileits -->
    ...
    <div class="col-md-8 products-right">
      <h5 id="member_banner">管理<span>訂單內容</span></h5>
      <div class="member_admin">
		        <form class="form-horizontal form-inline" name="form1" id="form1" method="post">
		                <input type="hidden" name="oper" id="oper" value="insert">
										<input type="hidden" name="no" id="no" value="<?php echo $_GET['order']?>">
		                <table id="edit" class="table table-striped table-bordered">
		                    <thead>
		                        ...
		                        <tr>
															...
															<td class="text-center">
																	<input type="text" id="order_gd" name="order_gd">
															</td>
															<td class="text-center">
																	<input type="text" id="order_amount" name="order_amount">
															</td>
		                            <td class="text-center">
		                                <input type="text" id="order_color" name="order_color">
		                            </td>
		                            <td class="text-center">
		                                <input type="text" id="order_size" name="order_size">
		                            </td>
		                            <td>
  ...
  <script type="text/javascript" src="js/bootstrap.js"></script>
	...
	$(document).ready(function() {
	 ...
	 $('tbody').on('click', '#btn_update', function() {
	    ...
	    $('#order_no').val(data[0]);
	    $('#order_gd').val(data[1]);
	    $('#order_amount').val(data[2]);
	    $('#order_color').val(data[3]);
			$('#order_size').val(data[4]);
	    $("#oper").val("update");
	 });
