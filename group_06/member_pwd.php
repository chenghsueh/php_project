  ...
  <!-- banner-bootom-w3-agileits -->
	...
	<div class="container">
		...
		<div class="col-md-8 products-right">
			<h5 id="member_banner">更<span>換密碼</span></h5>
			<div class="member_update">
				<form id="password_change">
							<div class="form-group">
								<label for:"old_pwd">請輸入舊密碼 : </label>
								<input type="text" class="form-control" id="old_pwd" name="old_pwd">
							</div>
							<div class="form-group">
								<label for:"new_pwd">請輸入新密碼 : </label>
								<input type="password" class="form-control" id="new_pwd" name="new_pwd">
							</div>
							<div class="form-group">
								<label for:"con_pwd">請再次輸入新密碼 : </label>
								<input type="password" class="form-control" id="con_pwd" name="con_pwd">
							</div>
...
<script>
	$(document).on( 'submit' , '#password_change' , function(event){
		event.preventDefault()
		$.ajax({
			url: "pwd_change.php",
