  ...
  <!-- banner-bootom-w3-agileits -->
	...
	<div class="container">
		...
		<div class="col-md-8 products-right">
			<h5 id="member_banner">管理<span>訂單</span></h5>
        ...
        <form class="form-horizontal form-inline" name="form1" id="form1" method="post">
                <input type="hidden" name="oper" id="oper" value="insert">
								<input type="hidden" name="order_old_no" id="order_old_no">
                <table id="edit" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th class="text-center">訂單編號</th>
                            <th class="text-center">購買人</th>
                            <th class="text-center">送貨地址</th>
                            <th class="text-center">是否已送貨</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <input type="text" id="order_addr" name="order_addr">
                            </td>
                            <td class="text-center">
                                <select id="order_sent" name="order_sent">
...
$(document).ready(function() {
 ...
 $('tbody').on('click', '#btn_update', function() {
    ...
    $('#order_no').val(data[1]);
    $('#order_user').val(data[2]);
    $('#order_addr').val(data[3]);
    $('#order_sent').val(data[4]);
		$('#order_old_no').val(data[1]);
    $("#oper").val("update");
 });
