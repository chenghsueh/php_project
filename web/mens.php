  ...
  <!-- banner-bootom-w3-agileits -->
	...
	<div class="container">
		...
		<div class="col-md-8 products-right">
			<h5>總<span>商品數量(0)</span></h5>
			<div class="sort-grid">
				<div class="sorting">
					<h6>排序:</h6>
					<select id="country1" onchange="change_country(this.value)" class="frm-field required sect">
						<option value="null">購買評價最高</option>
						<option value="null">價格(高到低)</option>
						<option value="null">價格(低到高)</option>
						<option value="null">購買人氣最高</option>
						<option value="null">最新上架</option>
					</select>
					<div class="clearfix"></div>
				</div>
				<div class="sorting">
				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.php">男士外套</a></h4>
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.php">男士手錶</a></h4>
										<div class="info-product-price">
			...
			<div class="col-md-3 product-men">
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.php">深藍色長褲</a></h4>
										<div class="info-product-price">
											<span class="item_price">$80</span>
											<del>$89</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.php">長袖T恤</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.php">深色牛仔褲</a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single.php">深色皮帶</a></h4>
										<div class="info-product-price">
