	...
	<div class="container">
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<div class="occasional">
						<h5>Types :</h5>
						<div class="colr ert">
							<label class="radio"><input type="radio" name="radio" checked=""><i></i>藍色</label>
						</div>
						<div class="colr">
							<label class="radio"><input type="radio" name="radio"><i></i>粉色</label>
						</div>
						<div class="colr">
							<label class="radio"><input type="radio" name="radio"><i></i>米色</label>
						</div>
						<div class="clearfix"> </div>
					</div>
									...
									<div class="bootstrap-tab-text-grid">
										...
										<div class="bootstrap-tab-text-grid-right">
											<ul>
												...
												<li><a href="#"><i class="fa fa-reply-all" aria-hidden="true"></i>回復</a></li>
											</ul>
											<p>請問藍色還有貨嗎</p>
										</div>
										<div class="clearfix"> </div>
